...
export default function TambahSaldoPengelolaanKas() {
    ...
    const statuSaldoPengelolaanKas = useSelector(state => state.saldoPengelolaanKas.tambah)
    ...
    const kembali = () => {
        navigate(routeName.saldoPengelolaanKas)
    }
    ...
    return(
        <div className="p-9 rounded-lg h-full w-full">
            <div className="
                            ...
                            "
            >
                <h1 className="text-lg font-extrabold dark:text-white">Tambah Saldo Pengelolaan Kas</h1>
