...
import SubTableDetailPendapatan2 from "./subTableDetailPendapatan2";
import rupiah from "../helpers/rupiah";
import ButtonEdit from "./buttonEdit";
import ButtonDelete from "./buttonDelete";

export default function SubTableDetailPendapatan({data, handleDelete, handleEdit}) {
                ...
                data.map((row, index) => (  
                    <React.Fragment key={row.id}>
                        ...
                        </tr>
                        {
                            ...
                            selectedRow === index && 
                            <SubTableDetailPendapatan2 handleDelete={handleDelete} handleEdit={handleEdit} data={row["subPendapatan"]} />
